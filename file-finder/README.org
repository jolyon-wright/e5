...
My thinking here is that, given no tests, the likelihood of producing something that works reliably is minimal so let's try and focus on producing a package that makes it easy-ish to understand why things don't work.
